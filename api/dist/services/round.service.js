...
tsyringe_1.container.register("IroundRepository", {
    useClass: round_repository_1.default,
});
var RoundService = /** @class */ (function () {
    function RoundService(roundRepository) {
    ...
    RoundService.prototype.getAllRounds = function () {
        return __awaiter(this, void 0, void 0, function () {
            var Rounds;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.roundRepository.getAllRounds()];
                    case 1:
                        Rounds = _a.sent();
    ...
    RoundService.prototype.createRound = function (round) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.roundRepository.createRound(round)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    RoundService.prototype.getRoundById = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            var Round;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.roundRepository.getRoundById(id)];
                    case 1:
                        Round = _a.sent();
    ...
    RoundService.prototype.updateRoundById = function (id, round) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.roundRepository.updateRoundById(id, round)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    RoundService.prototype.deleteRoundById = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.roundRepository.deleteRoundById(id)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
